/* 
   This file should replace the file found here: https://github.com/espressif/esp-adf/blob/master/examples/player/pipeline_bt_sink/main/play_bt_music_example.c
